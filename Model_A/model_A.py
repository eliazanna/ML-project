...
batch_size  = 32
epochs      = 20      # con early stopping si fermerà prima
base_dir    = "D:/DESKTOP/Desktop/ML-project/Model_A/rps-augmented"
...
#Normalizzazione - no altra data augmentation
train_data = train_data.map(lambda x, y: (x / 255.0, y))
val_data   = val_data.map(lambda x, y: (x / 255.0, y))

#Modello CNN molto semplice (2 conv layers)
...
plt.title("Model A - Accuracy baseline")
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.legend()
plt.show()
...
#salvo modello ed errori
model.save("D:/DESKTOP/Desktop/ML-project/Model_A/predictor_A.keras")
WRONG_DIR     = "D:/DESKTOP/Desktop/ML-project/Model_A/wrong_predictions"
